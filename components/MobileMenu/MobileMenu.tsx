...
const MobileMenu = ({links, isOtherPage}: IHeaderProps) => {
  ...
  return (
    <>
      ...
      <div className={`${active && 'translate-x-0'} flex flex-col items-center pt-40 fixed top-[60px] left-0 w-full h-screen bg-background bg-opacity-[0.97] -translate-x-[100%] transition duration-[400ms] ease-in-out md:top-[80px] lg:hidden`}>
